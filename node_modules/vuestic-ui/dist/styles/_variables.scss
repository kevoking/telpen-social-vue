...
$sidebar-width--hidden: 3.5rem !default;
...
$toast-width: 330px !default;
$toast-padding: 14px 26px 14px 13px !default;
$toast-radius: 8px !default;
$toast-shadow: 0 2px 12px 0 rgba(0, 0, 0, 0.1) !default;
$toast-icon-size: 24px !default;
$toast-close-font-size: $font-size-base !default;
$toast-group-margin-left: 13px !default;
$toast-group-margin-right: 8px !default;
$toast-content-font-size: $font-size-base !default;
$toast-content-color: #606266 !default;
$toast-title-font-size: $font-size-base !default;
$toast-title-color: #303133 !default;

$toast-close-color: #909399 !default;
$toast-close-hover-color: #909399 !default;

$toast-success-icon-color: $brand-success !default;
$toast-info-icon-color: $brand-info !default;
$toast-warning-icon-color: $theme-warning !default;
$toast-danger-icon-color: $theme-danger !default;
...
$toast-bg: $darkest-gray !default;
$toast-border-radius: $font-size-base * 0.5 !default;
...
$datepicker-box-shadow: 0 2px 3px 0 rgba(98, 106, 119, 0.25) !default;
...
$modal-transform-transition: transform $basic-duration ease !default;
$modal-opacity-transition: opacity ($basic-duration / 2) cubic-bezier(1, 0.5, 0.8, 1) !default;
$modal-overlay-opacity-transition: opacity (2 * $basic-duration / 3) cubic-bezier(1, 0.5, 0.8, 1) !default;
